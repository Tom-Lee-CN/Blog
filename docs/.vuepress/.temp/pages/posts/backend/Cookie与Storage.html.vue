<template><div><h1 id="cookie-and-storage" tabindex="-1"><a class="header-anchor" href="#cookie-and-storage"><span>cookie and storage</span></a></h1>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="在nodejs中获取cookie" tabindex="-1"><a class="header-anchor" href="#在nodejs中获取cookie"><span>在nodejs中获取cookie</span></a></h2>
...
<h4 id="使用方法-2" tabindex="-1"><a class="header-anchor" href="#使用方法-2"><span>使用方法</span></a></h4>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// 设置和修改Storage  </span></span>
